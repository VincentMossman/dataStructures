...
-- Date         February 28, 2014
   ...
   -- Postconditions : The product of Left and Right is returned
      ...
      -- Variables
      Result : Big_Natural; -- Result of multiplication
      Carry  : Natural;     -- Carry
   ...
   function To_Big_Natural (Item : in Natural) return Big_Natural is
      ...
      -- Variables
      Result     : Big_Natural;   -- Result of To_Big_Natural
      Num_Digits : Natural;   -- Number of digits in Item
      Item_Copy  : Natural;   -- For Recycling original result
   ...
   function "*" (Left : in Big_Natural; Right : in Big_Natural) return Big_Natural is
      ...
      -- Variable
      Result : Big_Natural; -- Result

   begin

      -- Initialize Result
      Result.Reference := new Digit_Array'(0 .. Left.Reference.all'Last + Right.Reference.all'Last => 0);
