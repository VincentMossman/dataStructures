...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_stack_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e10a9cba#;
   pragma Export (C, u00001, "stack_testB");
   ...
   u00046 : constant Version_32 := 16#f6fc5406#;
   ...
   u00097 : constant Version_32 := 16#5b340b01#;
   pragma Export (C, u00097, "stackB");
   u00098 : constant Version_32 := 16#b4e2e1ee#;
   pragma Export (C, u00098, "stackS");
   u00099 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00099, "system__concat_2B");
   u00100 : constant Version_32 := 16#a4185caa#;
