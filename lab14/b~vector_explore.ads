...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_vector_explore" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f4943900#;
   pragma Export (C, u00001, "vector_exploreB");
   ...
   u00012 : constant Version_32 := 16#795476c2#;
   ...
   u00014 : constant Version_32 := 16#3293d48b#;
   ...
   u00016 : constant Version_32 := 16#e92aa296#;
   ...
   u00018 : constant Version_32 := 16#4ba689f8#;
   ...
   u00043 : constant Version_32 := 16#0de94017#;
   ...
   u00045 : constant Version_32 := 16#fc6a127a#;
   pragma Export (C, u00045, "system__stack_checkingS");
   u00046 : constant Version_32 := 16#8cbe6205#;
   pragma Export (C, u00046, "ada__finalizationB");
   u00047 : constant Version_32 := 16#22e22193#;
   pragma Export (C, u00047, "ada__finalizationS");
   u00048 : constant Version_32 := 16#1358602f#;
   ...
   u00058 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00058, "system__finalization_rootB");
   u00059 : constant Version_32 := 16#103addc6#;
   pragma Export (C, u00059, "system__finalization_rootS");
   u00060 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00060, "ada__float_text_ioB");
   u00061 : constant Version_32 := 16#e61b3c6c#;
   pragma Export (C, u00061, "ada__float_text_ioS");
   u00062 : constant Version_32 := 16#421d3150#;
   pragma Export (C, u00062, "ada__text_ioB");
   u00063 : constant Version_32 := 16#152cee1e#;
   pragma Export (C, u00063, "ada__text_ioS");
   u00064 : constant Version_32 := 16#e0b7a7e8#;
   pragma Export (C, u00064, "interfaces__c_streamsB");
   u00065 : constant Version_32 := 16#95ad191f#;
   pragma Export (C, u00065, "interfaces__c_streamsS");
   u00066 : constant Version_32 := 16#36e568f7#;
   pragma Export (C, u00066, "system__crtlS");
   u00067 : constant Version_32 := 16#228a5436#;
   pragma Export (C, u00067, "system__file_ioB");
   u00068 : constant Version_32 := 16#ce89cf71#;
   pragma Export (C, u00068, "system__file_ioS");
   u00069 : constant Version_32 := 16#b46168d5#;
   pragma Export (C, u00069, "ada__io_exceptionsS");
   u00070 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00070, "interfaces__cB");
   u00071 : constant Version_32 := 16#29899d4e#;
   pragma Export (C, u00071, "interfaces__cS");
   u00072 : constant Version_32 := 16#507533cc#;
   pragma Export (C, u00072, "interfaces__c__stringsB");
   u00073 : constant Version_32 := 16#603c1c44#;
   pragma Export (C, u00073, "interfaces__c__stringsS");
   u00074 : constant Version_32 := 16#d6bc4ecc#;
   pragma Export (C, u00074, "system__crtl__runtimeS");
   u00075 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00075, "system__img_enum_newB");
   u00076 : constant Version_32 := 16#d8cf65a6#;
   pragma Export (C, u00076, "system__img_enum_newS");
   u00077 : constant Version_32 := 16#f6ee85e9#;
   pragma Export (C, u00077, "system__os_libB");
   u00078 : constant Version_32 := 16#89dce9aa#;
   pragma Export (C, u00078, "system__os_libS");
   u00079 : constant Version_32 := 16#4cd8aca0#;
   pragma Export (C, u00079, "system__stringsB");
   u00080 : constant Version_32 := 16#e822e492#;
   pragma Export (C, u00080, "system__stringsS");
   u00081 : constant Version_32 := 16#782cc428#;
   pragma Export (C, u00081, "system__file_control_blockS");
   u00082 : constant Version_32 := 16#91d2300e#;
   pragma Export (C, u00082, "system__finalization_mastersB");
   u00083 : constant Version_32 := 16#353d027a#;
   ...
   u00091 : constant Version_32 := 16#8c66b13b#;
   ...
   u00105 : constant Version_32 := 16#9860ffb4#;
   pragma Export (C, u00105, "system__img_realS");
   u00106 : constant Version_32 := 16#80f37066#;
   pragma Export (C, u00106, "system__fat_llfS");
   u00107 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00107, "system__float_controlB");
   u00108 : constant Version_32 := 16#bf34ed6a#;
   pragma Export (C, u00108, "system__float_controlS");
   u00109 : constant Version_32 := 16#06417083#;
   pragma Export (C, u00109, "system__img_lluB");
   u00110 : constant Version_32 := 16#7ce0f2e3#;
   pragma Export (C, u00110, "system__img_lluS");
   u00111 : constant Version_32 := 16#194ccd7b#;
   pragma Export (C, u00111, "system__img_unsB");
   u00112 : constant Version_32 := 16#aaddced7#;
   pragma Export (C, u00112, "system__img_unsS");
   u00113 : constant Version_32 := 16#0fb8c821#;
   pragma Export (C, u00113, "system__powten_tableS");
   u00114 : constant Version_32 := 16#8ff77155#;
   pragma Export (C, u00114, "system__val_realB");
   u00115 : constant Version_32 := 16#a1e1d947#;
   pragma Export (C, u00115, "system__val_realS");
   u00116 : constant Version_32 := 16#0be1b996#;
   pragma Export (C, u00116, "system__exn_llfB");
   u00117 : constant Version_32 := 16#de4cb0b9#;
   pragma Export (C, u00117, "system__exn_llfS");
   u00118 : constant Version_32 := 16#dc11d781#;
   pragma Export (C, u00118, "system__fat_fltS");
   u00119 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00119, "ada__integer_text_ioB");
   u00120 : constant Version_32 := 16#f1daf268#;
   pragma Export (C, u00120, "ada__integer_text_ioS");
   ...
   u00123 : constant Version_32 := 16#ef6c8032#;
   pragma Export (C, u00123, "system__img_biuB");
   u00124 : constant Version_32 := 16#f30b7a6d#;
   pragma Export (C, u00124, "system__img_biuS");
   u00125 : constant Version_32 := 16#10618bf9#;
   pragma Export (C, u00125, "system__img_llbB");
   u00126 : constant Version_32 := 16#b2cc6a93#;
   pragma Export (C, u00126, "system__img_llbS");
   u00127 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00127, "system__img_lliB");
   u00128 : constant Version_32 := 16#4e87fb87#;
   pragma Export (C, u00128, "system__img_lliS");
   u00129 : constant Version_32 := 16#f931f062#;
   pragma Export (C, u00129, "system__img_llwB");
   u00130 : constant Version_32 := 16#1ba04905#;
   pragma Export (C, u00130, "system__img_llwS");
   u00131 : constant Version_32 := 16#b532ff4e#;
   pragma Export (C, u00131, "system__img_wiuB");
   u00132 : constant Version_32 := 16#9d4afdff#;
   pragma Export (C, u00132, "system__img_wiuS");
   u00133 : constant Version_32 := 16#c31442ce#;
   pragma Export (C, u00133, "system__val_intB");
   u00134 : constant Version_32 := 16#176d8469#;
   pragma Export (C, u00134, "system__val_intS");
   u00135 : constant Version_32 := 16#d3757657#;
   pragma Export (C, u00135, "system__val_lliB");
   u00136 : constant Version_32 := 16#c5ec48f6#;
   pragma Export (C, u00136, "system__val_lliS");
   u00137 : constant Version_32 := 16#25c21d28#;
   pragma Export (C, u00137, "system__val_lluB");
   u00138 : constant Version_32 := 16#4fdba552#;
   pragma Export (C, u00138, "system__val_lluS");
   u00139 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00139, "system__concat_2B");
   u00140 : constant Version_32 := 16#a4185caa#;
